"use strict";
(self["webpackChunkvue_counter"] = self["webpackChunkvue_counter"] || []).push([[539],{
...
function triggerRef(ref2) {
  triggerRefValue(ref2, 5,  false ? 0 : void 0);
}
function unref(ref2) {
...
const normalizeRef = ({
  ...
  return ref != null ? isString(ref) || isRef(ref) || shared_esm_bundler_isFunction(ref) ? { i: currentRenderingInstance, r: ref, k: ref_key, f: !!ref_for } : ref : null;
};
...
function _createVNode(type, props = null, children = null, patchFlag = 0, dynamicProps = null, isBlockNode = false) {
  ...
  const shapeFlag = isString(type) ? 1 : isSuspense(type) ? 128 : isTeleport(type) ? 64 : shared_esm_bundler_isObject(type) ? 4 : shared_esm_bundler_isFunction(type) ? 2 : 0;
  if (false) {}
